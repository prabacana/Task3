...
console.log(mutation_toNumber + " ===> Change type to number");
console.log(mutation_toFloat + " ===> Change type to float");
console.log(break_section);
console.log(break_void);
...
console.log(num_array.length + average + " ===> Average array");
console.log(break_section);
console.log(break_void);
